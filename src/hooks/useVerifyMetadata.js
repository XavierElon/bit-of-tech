...
export const useVerifyMetadata = () => {
  ...
  function generateMetadata(role) {
    let selectedRole = "";
    switch (role) {
    ...
    const metadata = {
      name: selectedRole + " NFT",
      description: selectedRole + " for IPFS",
      image: `ipfs://QmTrh1feMmtSw2HSbFqnQ4wJMTYqi6ReSXkYcaLiFuvcfS/0.jpg`,
      attributes: [
        {
          trait_type: "Role",
          value: selectedRole
  ...
  return { verifyMetadata, generateMetadata };
}; //useVerifyMetadata()
